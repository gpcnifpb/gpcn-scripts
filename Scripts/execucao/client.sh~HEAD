...
#tcpdump clientes
tcpdump -i eth0 -U -w client_$1.cap &

sleep 1

#Ping Atacado
ping 192.168.0.200 >> /gpcn/clientes/logs/ping/ping_$1_clt_01_srv_01.txt &

#Ping Nao-Atacado
ping 192.168.10.201 >> /gpcn/clientes/logs/ping/ping_$1_clt_01_srv_02.txt &
